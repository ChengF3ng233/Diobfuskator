package cn.feng.util.reflection;
...
public final class DynamicReflection implements Opcodes {
    ...
    public static MethodHandleInfo revealMethodInfo(MethodHandle handle)
        ...
        if (clazz.getName().startsWith(BMHL)) {
            ...
            Util.info("Wrong java version! Please use Java 8 to decrypt MethodHandles properly.");
        }
    ...
    public static Lookup getTrustedLookup()
            throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
        Field impl = Lookup.class.getDeclaredField("IMPL_LOOKUP");
