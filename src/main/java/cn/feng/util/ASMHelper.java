...
public class ASMHelper extends Util implements Opcodes {
    ...
    public static AbstractInsnNode find(MethodNode method, AbstractInsnNode insn, int index) {
        int i = method.instructions.indexOf(insn);
        return method.instructions.get(i + index);
    }
